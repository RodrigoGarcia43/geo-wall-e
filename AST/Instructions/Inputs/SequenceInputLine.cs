...
namespace GeoWall_E
{
    class SequenceInputLine : Input
    {
        public SequenceInputLine(CodeLocation location) : base(location)
        {
        }
        ...
        internal override void Execute(Scope table, Action<Expression> drawer, Action<string> error, Action<string> ChangeColor, Stack<string> LastColors)
        {
            ...
            table.Executing.Add(Id, new VarInfo(item, ExpressionType.LineSequence));
        }
    }
}
