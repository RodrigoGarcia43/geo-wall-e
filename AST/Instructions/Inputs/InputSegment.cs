...
namespace GeoWall_E
{
    class InputSegment : Input
    {
        public InputSegment(CodeLocation location) : base(location)
        {
        }
        ...
        public override void CheckSemantic(Scope table, List<CompilingError> errors)
        {
            ...
            {
                table.Compiling.Add(Id, ExpressionType.Segment);
                isOk = true;
            }
        }
        ...
        {
            body = new Segment();
            table.Executing.Add(Id, new VarInfo(body, ExpressionType.Segment));
        }
    }
}
